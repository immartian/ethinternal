...
function  getInternalsFromBlock(bHash){
web3.eth.getBlock(bHash).then(async function(block) {
...
blockHash= "0x936b109ad813df99ae7b57c98c0019987eca8b986d2cd85b368620f561999532" // (#2031)
getInternalsFromBlock(blockHash); 
